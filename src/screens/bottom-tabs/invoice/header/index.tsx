...
import {useSearchInvoiceApiQuery} from '../../../../state/services/invoice/api';
...
const InvoiceHeader: FunctionComponent<{
  ...
  const {currentData = [], isFetching: isSearching} = useSearchInvoiceApiQuery(
    {
