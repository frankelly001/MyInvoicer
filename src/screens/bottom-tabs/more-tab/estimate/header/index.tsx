...
import {useSearchEstimateApiQuery} from '../../../../../state/services/estimate/api';
...
const EstimateHeader: FunctionComponent<{
  ...
  const {currentData = [], isFetching: isSearching} = useSearchEstimateApiQuery(
    {
