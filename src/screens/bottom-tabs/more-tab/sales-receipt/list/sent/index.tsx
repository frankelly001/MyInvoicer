...
const ReceiptSentList: FunctionComponent<{
  onScroll?:
  ...
  } = useGetAllReceiptsApiQuery(receiptApiListParams.sent, {
  ...
  return (
    <>
      <AppFlashList
        ...
        emptyListAlert={{
          description:
            'Create your first sales receipt and start billing your customers. ',
          buttonText: 'Create sales receipt',
...
export default ReceiptSentList;
